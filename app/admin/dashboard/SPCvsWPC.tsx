...
//   { date: "2024-06-26", WPC: 0, SPC: 0 },
//   { date: "2024-06-27", WPC: 448, SPC: 490 },
//   { date: "2024-06-28", WPC: 149, SPC: 0 },
//   { date: "2024-06-29", WPC: 103, SPC: 160 },
//   { date: "2024-06-30", WPC: 0, SPC: 400 },
// ]
...
export function SPCandWPCComparison() {
  const isMobile = useIsMobile()
  const [timeRange, setTimeRange] = React.useState("30d")
  const [chartData, setChartData] = React.useState<ChartItem[]>([]);
  React.useEffect(() => {
    const chartDatas = async () => {
      const res = await fetch("/api/admin/statistics/categoryComparisonChart", {
        credentials: 'include',
      })
